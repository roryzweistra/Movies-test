...
// in simulator we redefine to format for Movies Developer console
...
{\
	NSString * exceptionName = [@"org.movies." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.movies";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIMoviesNativeItemNone = -1, 
	UIMoviesNativeItemSpinner = -2,
	UIMoviesNativeItemProgressBar = -3,
	
	UIMoviesNativeItemSlider = -4,
	UIMoviesNativeItemSwitch = -5,
	UIMoviesNativeItemMultiButton = -6,
	UIMoviesNativeItemSegmented = -7,
	
	UIMoviesNativeItemTextView = -8,
	UIMoviesNativeItemTextField = -9,
	UIMoviesNativeItemSearchBar = -10,
	
	UIMoviesNativeItemPicker = -11,
	UIMoviesNativeItemDatePicker = -12,
	
	UIMoviesNativeItemInfoLight = -13,
	UIMoviesNativeItemInfoDark = -14,
	
	UIMoviesNativeItemDisclosure = -15,
	
	UIMoviesNativeItemContactAdd = -16
};
